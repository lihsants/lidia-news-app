...
if st.button("Open your letter 💌"):
    ...
    st.markdown(
        ...
        <div class="custom-container">
            ...
            <p>And I know you must be wondering "why does this crazy girl still talk to me?! And do she still think we'll see each other again?!" hahaha but if you put up with me for another month, I'll tell you, if not you'll never know👀 lol</p>
